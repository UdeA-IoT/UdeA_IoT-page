...
# Sesión 7 - Conexión Wifi para el ESP32

:::note[**Objetivos**]
* Comprender los pasos necesarios para configurar y conectar una placa ESP32 a una red Wifi.
* Aprender a usar las estructuras de datos de la libreria Wifi del API de Arduino para hacer aplicaciones que hagan uso de comunicación usando Wifi.
* Ilustrar diferentes escenarios de aplicación en los que se puede usar la conexión Wifi.
:::
...
![seleccion_modulo](/img/sesiones/percepcion/7/modulo_esp32.png)

2. Conecte el modulo NodeMCU-32S al PC.

4. Seleccione el puerto.

![seleccion_puerto](/img/sesiones/percepcion/7/puerto_seleccion.png)
...
![ejemplo_scan](/img/sesiones/percepcion/7/esp32_wifi_scan.png)
...
![conexion](/img/sesiones/percepcion/7/conexion.png)
...
![scaneo](/img/sesiones/percepcion/7/scann_wifi_terminal.png)
