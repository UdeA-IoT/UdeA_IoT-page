...
Este es una variación del ejemplo anterior ([ejemplo1](sesion7b#)) la cual consiste en agregar los dispositivos en una red ya disponible (como la del LIS por ejemplo). En este caso, solo se usará el ESP32 que hace de servidor y un pc (portatil y telefono movil) como cliente tal y como se muestra en la siguiente figura:
   
![red_ESP32](/img/sesiones/percepcion/7/ejemplo2/net_esp32-STA.png)
...
La red compuesta por un portatil y un ESP32 los cuales se conectan a traves de un AP inalambrico. Cada uno de los elementos esta configurado para funcionar de acuerdo a la siguiente descripción:
...
![esp32STA](/img/sesiones/percepcion/7/ejemplo2/esp32STA.png)
...
![salida_STA](/img/sesiones/percepcion/7/ejemplo2/salida_STA.png)
...
![salida_servidor_ESP](/img/sesiones/percepcion/7/ejemplo2/server_station_client.png)
...
![ejemplo_SimpleWiFiServer](/img/sesiones/percepcion/7/ejemplo2/ejemplo_SimpleWiFiServer.png)
